...
const tasks = [
  'Post on twitter.com with content "An automated post from ibra-kdbra by @ibra-kdbra! :)" If I\'m not logged in, fail the task and wait for me to log in.',
    ...
    <VStack spacing={2} align="stretch">
      ...
      >
        ...
        <Text fontWeight={400} noOfLines={1} color="gray">
          with content &quot;An automated post from ibra-kdbra by
          @ibra-kdbra!&quot;
        </Text>
      </Button>
      <Button
